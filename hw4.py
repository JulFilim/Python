...
n = set(randint(1, 20) for i in range(int(input('Введите элементы первого множества: '))))
print(n)
m = set(randint(1, 20) for i in range(int(input('Введите элементы второго множества: '))))
print(m)
s = sorted(n.intersection(m))
print(f"пересечение {s}")
...
from random import randint
list_1 = list(randint(1, 5) for i in range(int(input('Введите число кустов: '))))
print(list_1)
...
if x == 1:
    ...
    res = list_1[x-1] + list_1[x-2] + list_1[x]
print(res, 'ягод')